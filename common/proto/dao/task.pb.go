...
type CondCounter struct {
	Typ   int64           `protobuf:"varint,1,opt,name=typ,proto3" json:"typ,omitempty" pk`
...
func (*CondCounter) Descriptor() ([]byte, []int) {
	return fileDescriptor_9a65a2c8732147ec, []int{0}
}
...
func (*TaskMapper) Descriptor() ([]byte, []int) {
	return fileDescriptor_9a65a2c8732147ec, []int{1}
}
...
func (*TaskMapper) XXX_MessageName() string {
	return "dao.TaskMapper"
}

type Task struct {
	SysId models.SystemType      `protobuf:"varint,1,opt,name=sys_id,json=sysId,proto3,enum=models.SystemType" json:"sys_id,omitempty" pk`
	Tasks map[int64]*models.Task `protobuf:"bytes,2,rep,name=tasks,proto3" json:"tasks,omitempty" protobuf_key:"varint,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
}

func (m *Task) Reset()      { *m = Task{} }
func (*Task) ProtoMessage() {}
func (*Task) Descriptor() ([]byte, []int) {
	return fileDescriptor_9a65a2c8732147ec, []int{2}
}
...
func (m *Task) GetSysId() models.SystemType {
	if m != nil {
		return m.SysId
	}
...
func (m *Task) GetTasks() map[int64]*models.Task {
	if m != nil {
		return m.Tasks
	}
	return nil
...
func init() {
	proto.RegisterType((*CondCounter)(nil), "dao.CondCounter")
	proto.RegisterMapType((map[int64]int64)(nil), "dao.CondCounter.CountEntry")
	proto.RegisterType((*TaskMapper)(nil), "dao.TaskMapper")
	proto.RegisterMapType((map[int64]int64)(nil), "dao.TaskMapper.MapperEntry")
	proto.RegisterType((*Task)(nil), "dao.Task")
	proto.RegisterMapType((map[int64]*models.Task)(nil), "dao.Task.TasksEntry")
}

func init() { proto.RegisterFile("proto/dao/task.proto", fileDescriptor_9a65a2c8732147ec) }

var fileDescriptor_9a65a2c8732147ec = []byte{
	// 395 bytes of a gzipped FileDescriptorProto
	,
}
...
func (m *CondCounter) PKAppendTo(d []byte) []byte {
	if m == nil {
		return d
	}
...
func (m *CondCounter) ToKVSave() ([]byte, []byte) {
...
func (m *CondCounter) ToSave() []byte {
	msgName := m.XXX_MessageName()
	ml := len(msgName)
...
func (m *CondCounter) KVKey() string {
	return m.XXX_MessageName() + ":k:" + m.PK()
}

func (m *TaskMapper) PK() string {
	if m == nil {
		return ""
	}
...
func (m *TaskMapper) PKAppendTo(d []byte) []byte {
	if m == nil {
		return d
	}
...
func (m *TaskMapper) ToKVSave() ([]byte, []byte) {
	msgName := m.XXX_MessageName()
	dk := coin_server_common_bytespool.GetSample(64)
	dk = dk[:0]
	dk = append(dk, msgName...)
...
func (m *TaskMapper) KVKey() string {
	return m.XXX_MessageName() + ":k:" + m.PK()
}

func (m *Task) PK() string {
	if m == nil {
		return ""
	}
	return strconv.FormatInt(int64(m.SysId), 10)
}

func (m *Task) PKAppendTo(d []byte) []byte {
	if m == nil {
		return d
	}
	return strconv.AppendInt(d, int64(m.SysId), 10)
}

func (m *Task) ToKVSave() ([]byte, []byte) {
	msgName := m.XXX_MessageName()
	dk := coin_server_common_bytespool.GetSample(64)
	dk = dk[:0]
	dk = append(dk, msgName...)
...
func (m *Task) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.SysId != 0 {
		i = encodeVarintTask(dAtA, i, uint64(m.SysId))
		i--
		dAtA[i] = 0x8
	}
	return len(dAtA) - i, nil
	...
	for iNdEx < l {
		...
		case 1:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.SysId |= models.SystemType(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 2:
			...
			if m.Tasks == nil {
				m.Tasks = make(map[int64]*models.Task)
			}
			var mapkey int64
			var mapvalue *models.Task
			for iNdEx < postIndex {
				entryPreIndex := iNdEx
				var wire uint64
				for shift := uint(0); ; shift += 7 {
